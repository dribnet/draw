...
from draw.nonrecursivecheckpoint import NonRecursiveCheckpoint
...
#                updates=scan_updates, 
                prefix="test"),
            NonRecursiveCheckpoint("{}/{}".format(subdir,name), before_training=True, after_epoch=True, save_separately=['log', 'model']),
